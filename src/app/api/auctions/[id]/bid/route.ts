...
export async function POST(
  ...
  try {
    ...
    // 3. Execute Complete Database Operations inside One Atomic Transaction
    const result = await prisma.$transaction(async (tx) => {
      ...
      // Fetch fresh auction state directly from DB
      ...
      // Log user activity directly into DB
